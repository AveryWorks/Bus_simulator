...
//        }
        while (activo == true) {
            if (i == 1) {
                ...
                ClienteView.N15.setIcon(new ImageIcon(ClienteView.imgbus4));
                i++;
                try {
                    sleep(tiempo);
            ...
            if (i == 2) {
                ...
                ClienteView.N16.setIcon(new ImageIcon(ClienteView.imgbus4));
                i++;
                try {
                    sleep(tiempo);
                } catch (InterruptedException e) {
            ...
            if (i == 3) {
                ...
                ClienteView.N17.setIcon(new ImageIcon(ClienteView.imgbus4));
                i++;
                try {
                    sleep(tiempo);
                } catch (InterruptedException e) {
                ...
                if (i == 4) {
                    ...
                    ClienteView.N18.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 5) {
                    ...
                    ClienteView.N19.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 6) {
                    ...
                    ClienteView.N20.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 7) {
                    ...
                    ClienteView.N1.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 8) {
                    ...
                    ClienteView.N2.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 9) {
                    ...
                    ClienteView.N3.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 10) {
                    ...
                    ClienteView.N4.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 11) {
                    ...
                    ClienteView.N5.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 12) {
                    ...
                    ClienteView.N6.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 13) {
                    ...
                    ClienteView.N7.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 14) {
                    ...
                    ClienteView.N8.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 15) {
                    ...
                    ClienteView.N9.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 16) {
                    ...
                    ClienteView.N10.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 17) {
                    ...
                    ClienteView.N11.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 18) {
                    ...
                    ClienteView.N12.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 19) {
                    ...
                    ClienteView.N13.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i++;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
                ...
                if (i == 20) {
                    ...
                    ClienteView.N14.setIcon(new ImageIcon(ClienteView.imgbus4));
                    i = 1;
                    try {
                        sleep(tiempo);
                    } catch (InterruptedException e) {
        ...
        System.out.println("Bus 4 se ha detenido");
    }
}
